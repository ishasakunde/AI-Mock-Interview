...
function RecordAnswerSection(mockInterviewQuestion,activeQuestionIndex,interviewData) {
    ...
    //   useEffect(()=>{
    //     results.map((results)=>( 
    //         setUserAnswer(prevAns=>prevAns+results?.trasnscript)
    //     ))
    //   },[results])

    useEffect(() => {
        // Combine all results into a single string and update state once
    ...
    const UpdateUserAnswer=async()=>{
        ...
        const feedbackprompt = 
            ...
            ", Depends on questions and user answer for give interview question " +
